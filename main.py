...
# Pega as chaves salvas nas Variáveis de Ambiente do Render
...
async def blitz(ctx, *, nickname: str):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if not account_id:
            await msg.edit(content=f"Jogador **{nickname}** não foi encontrado em nenhuma região (`NA`, `EU`, `ASIA`).")
            return
        ...
        if battles_24 > 0:
            ...
            diario_txt = f"**Batalhas:** {battles_24}\n**Vitórias:** {wins_24}V / {battles_24 - wins_24}D\n**WR Diário:** {wr_24:.2f}%\n**Dano Médio:** {avg_dmg_24:.0f}"
        else:
        ...
        avg_dmg_all = (stats_all["damage_dealt"] / battles_all) if battles_all > 0 else 0
        ...
        embed.add_field(name="Desempenho Hoje (24h)", value=diario_txt, inline=False)
